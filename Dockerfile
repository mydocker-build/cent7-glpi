...
# Download Racktables
RUN cd /tmp/ && wget https://github.com/glpi-project/glpi/releases/download/$CORRECTIVE_VER/glpi-$MAJOR_VER.tgz && \
    tar -xzvf glpi-$MAJOR_VER.tgz -C /usr/src/ && \
    rm -rf /tmp/*
